...
`rank.py` computes a **global percentile-based ranking** of all your Non-Human Identities based on their control-plane and data-plane scores (WAR norm and blast radius). NHI Rank provides a compact, high-information view of identity risk across very large Azure environments.

### What NHI Rank does
- Reads the CSV generated by `silhouette.py`
- Normalizes WAR and blast radius
- Computes a combined NHI score
